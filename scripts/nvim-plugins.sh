...
defmodule NvimPlugins do
  ...
  @xdg_config_home System.get_env("HOME") <> "/.config"
  @nvim_config_path "#{@xdg_config_home}/nvim"
  @readme_path "#{@nvim_config_path}/README.md"
  @specs_path "#{@nvim_config_path}/lua/config/plugins"
...
# This is a shell file, but when opened by vim, we can tell it to read it as an
# elixir file
# vi:ft=elixir
